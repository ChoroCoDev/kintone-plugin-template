...
;// CONCATENATED MODULE: ./src/components/ConfigPage/index.tsx


var ConfigPage = function (props) {
    var _a = useForm({
        defaultValues: props,
    });
    return react.createElement("div", null, "ConfigPage");
};
/* harmony default export */ var components_ConfigPage = ((/* unused pure expression or super */ null && (ConfigPage)));

;// CONCATENATED MODULE: ./src/components/index.tsx


;// CONCATENATED MODULE: ./src/index.ts
var rootId = 'config-root';


;// CONCATENATED MODULE: ./src/ts/config.tsx
...
root.render(react.createElement(ConfigPage, __assign({}, config)));
